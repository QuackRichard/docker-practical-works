...
3. Почему именно эти программы?
   - VMware workstation - По сравнению с VMware Player и Oracle VirtualBox оказалась самой удобной для **именно** **меня**.
...
13. Установка Docker будет в следующем уроке, поздравляю тех, кто справились с этим уроком!
